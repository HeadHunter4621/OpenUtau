...
namespace OpenUtau.Plugin.Builtin {
    ...
    /// </summary>
    [Phonemizer("English X-SAMPA + phonemizer", "EN X-SAMPA +", "HeadHunter4621", language: "EN")]
    public class EnXSampaPhonemizer : SyllableBasedPhonemizer {
        protected override string YamlFileName => "en-xsampa.yaml";
        protected override byte[] YamlTemplate => EnXSampaPhonemizerPlus.Data.Resources.en_xsampa_template;
